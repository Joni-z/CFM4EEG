"""One Quad16 masked latent-prediction pretrain; raw masking before all filters.
...
def main():
    ...
    if args.smoke:
        ...
        assert net.student.frontend.waveform_quadrature.weight.grad is not None
