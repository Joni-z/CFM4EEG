...
assert ds in ['sleepedf', 'tuar', 'siena', 'caueeg', 'isruc'] and seed in [0, 1, 2]
os.chdir(ROOT)
cfgpath = ROOT / f'configs/a128_r1/{ds}_s{seed}.yaml'
...
lock = open(locks / f'run-a128r1-{ds}-s{seed}.lock', 'a')
try:
